<?php
	...
	$rows = [["ID", "First Name", "Last Name", "Campus", "Email"]];
	foreach ($students as $student)
	{
		$row = [$student->id, $student->firstName, $student->lastName, getCampus($student->campus), $student->email];
		$rows[] = $row;
	}
    ...
    $obj_pdf->Output("$unitID-students.pdf", "I");
?>
