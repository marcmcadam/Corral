...
<?php
    ...
    echo "<p><table width='1200px'  border='1px' cellpadding='10px'></p>";
    echo "<tr><th>Project Number</th><th>Project Brief</th><th>Project Status</th><th>Update Project</th></tr>";
    
    while ($row=mysqli_fetch_assoc($res)){
        echo "<tr><td align='center'>{$row['PROJECT_NUM']}</td><td align='center'>{$row['PROJECT_BRIEF']}</td><td align='center'>{$row['PROJECT_STATUS']}</td><td align='center'><a href='updatePro.php?number={$row['PROJECT_NUM']}'>Update</a></td></tr>";
    }
