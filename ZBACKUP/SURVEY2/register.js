$(document).ready(function(){
	...
	$('#submit').click(function(e) {
		...
		var techsk4 = $('form #techsk4').val();
		var techsk5 = $('form #techsk5').val();
		var techsk6 = $('form #techsk6').val();
		var techskpro1 = $('form #techskpro1').val();
		var techskpro2 = $('form #techskpro2').val();
		var techskpro3 = $('form #techskpro3').val();	
		var techskpro4 = $('form #techskpro4').val();
		var techskpro5 = $('form #techskpro5').val();
		var techskpro6 = $('form #techskpro6').val();	
		var softsk1 = $('form #softsk1').val();		
		var softsk2 = $('form #softsk2').val();
		var softsk3 = $('form #softsk3').val();
		var softsk4 = $('form #softsk4').val();
		var softsk5 = $('form #softsk5').val();
		var softsk6 = $('form #softsk6').val();
		var softskpro1 = $('form #softskpro1').val();
		var softskpro2 = $('form #softskpro2').val();
		var softskpro3 = $('form #softskpro3').val();
		var softskpro4 = $('form #softskpro4').val();
		var softskpro5 = $('form #softskpro5').val();
		var softskpro6 = $('form #softskpro6').val();
...
// Student Survey				
		...
		if(employ == ''){
			...
			e.preventDefault();
								...
								if(techsk4 == ''){
			valid += '<p>Invalid, Q6 Tech Skill 4 ' + required + '</p>';
			e.preventDefault();
		}
								if(techsk5 == ''){
			valid += '<p>Invalid, Q6 Tech Skill 5 ' + required + '</p>';
			e.preventDefault();
		}	
		
								if(techsk6 == ''){
			valid += '<p>Invalid, Q6 Tech Skill 6 ' + required + '</p>';
			e.preventDefault();
		}							
				if(techskpro1 == ''){
			...
			e.preventDefault();
				...
				if(techskpro4 == ''){
			valid += '<p>Invalid, Q7 Technical Skill Proficiency 4 ' + required + '</p>';
			e.preventDefault();
		}		

				if(techskpro5 == ''){
			valid += '<p>Invalid, Q7 Technical Skill Proficiency 5 ' + required + '</p>';
			e.preventDefault();
		}
		
						if(techskpro6 == ''){
			valid += '<p>Invalid, Q7 Technical Skill Proficiency 6 ' + required + '</p>';
			e.preventDefault();
		}
				if(softsk1 == ''){
			...
			e.preventDefault();
				...
				if(softsk4 == ''){
			valid += '<p>Invalid, Q8 Soft Skill 4 ' + required + '</p>';
			e.preventDefault();
		}		
				if(softsk5 == ''){
			valid += '<p>Invalid, Q8 Soft Skill 5 ' + required + '</p>';
			e.preventDefault();
		}	
				if(softsk6 == ''){
			valid += '<p>Invalid, Q8 Soft Skill 6 ' + required + '</p>';
			e.preventDefault();
		}			
				if(softskpro1 == ''){
			...
			e.preventDefault();
						...
						if(softskpro4 == ''){
			valid += '<p>Invalid, Q9 Soft Skill Proficiency 4 ' + required + '</p>';
			e.preventDefault();
		}		
		
						if(softskpro5 == ''){
			valid += '<p>Invalid, Q9 Soft Skill Proficiency 5 ' + required + '</p>';
			e.preventDefault();
		}
						if(softskpro6 == ''){
			valid += '<p>Invalid, Q9 Soft Skill Proficiency 6 ' + required + '</p>';
			e.preventDefault();
		}				
