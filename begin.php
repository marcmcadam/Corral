...
<form action="begin2.php" method="post">
    <table align='center'>
        <tr>
            ...
            <td style="min-width: 256px;">Running Time<br><input class="inputBox" type="text" name="iterations" value="<?php echo $sortIterations; ?>"></td>
            <td style="max-width: 768px;">
            ...
            <td style="min-width: 256px;">Quality<br><input class="inputBox" type="text" name="matrix" value="<?php echo $sortMatrix; ?>"></td>
            <td style="max-width: 768px;">
