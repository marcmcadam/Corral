...
<p><form action="../PROJECT/STAFFPROCESS.PHP" method="post"></p>
<p>Staff number <?php echo $_GET['number'];?></p>

<p>Firstname </p>
<p><input type="text" name="STAFF_FIRSTNAME" value="<?php echo $_GET['firstname'];?>"/></p>
<p>Lastname </p>
<p><input type="text" name="STAFF_LASTNAME" value="<?php echo $_GET['lastname'];?>"/></p>
<p>Location </p>
<p><input type="text" name="STAFF_LOCATION" value="<?php echo $_GET['location'];?>"/></p>
<p>Email </p>
<p><input type="text" name="STAFF_EMAIL" value="<?php echo $_GET['email'];?>"/></p>
