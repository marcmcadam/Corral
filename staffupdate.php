...
if(!isset($_POST['staffid'])){
  print "<h3>You must first choose a staff member to update</h3><a href='staffupdate.php'>You can select a staff memeber here</a>";
} else {
  ...
  if (!preg_match('/[0-9]$/', $staff_ID) ){
    ...
    while ($row=mysqli_fetch_assoc($result)){
      ...
      print "<p><form action='staffprocess.php' method='post'></p>";
      print "<p>Staff ID </p>
