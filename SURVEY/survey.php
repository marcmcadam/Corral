...
<option value="No">No</option>
  ...
  <blockquote>
    ...
    <p>
      <label for="techsk1">Tech Skill 4: </label>
      <input type="text" name="techsk4" id="techsk1" />
    </p>
    <p>
      <label for="techsk1">Tech Skill 5: </label>
      <input type="text" name="techsk5" id="techsk1" />
    </p>
    <p>
      <label for="techsk1">Tech Skill 6: </label>
      <input type="text" name="techsk6" id="techsk1" />
    </p>
  </blockquote>
  ...
  <blockquote>
    ...
    <p>Soft Skill 6:
      <input type="text" name="softsk6" id="softsk6" />
    </p>
  </blockquote>
  ...
  <blockquote>
    <p id="aspira" name="aspira" cols="100" rows="5">
  ...
  <blockquote>
    ...
    <input name="profile" type="text" id="profile" value="" size="100" />
  </blockquote>
  </p>
  ...
  <blockquote>
    ...
    <p>
      ...
      <textarea name="additi" cols="100" rows="6" id="additi"></textarea>
    </p>
    <p>&nbsp;</p>
  </blockquote>
